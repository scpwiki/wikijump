<?php /* Smarty version 2.6.7, created on 2009-01-04 19:47:39
         compiled from /var/www/wikidot/templates/modules/wiki/sitesactivity/MostActiveForumsModule.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 't', '/var/www/wikidot/templates/modules/wiki/sitesactivity/MostActiveForumsModule.tpl', 4, false),array('modifier', 'escape', '/var/www/wikidot/templates/modules/wiki/sitesactivity/MostActiveForumsModule.tpl', 31, false),)), $this); ?>
<div class="most-active-forums-box">
	<div class="when">
		...
		<?php else: ?>
			<a href="javascript:;" onclick="WIKIDOT.modules.MostActiveForumsModule.listeners.changeTime(event, 'month')"> <?php $this->_tag_stack[] = array('t', array()); smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat=true);while ($_block_repeat) { ob_start(); ?>month<?php $_block_content = ob_get_contents(); ob_end_clean(); echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat=false); }  array_pop($this->_tag_stack); ?></a>
		<?php endif; ?>
	</div>
	...
	<?php if ($this->_tpl_vars['res']): ?>
		<table class="item-list">
			<tr>
				<td>&nbsp;</td>
				<td><?php $this->_tag_stack[] = array('t', array()); smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat=true);while ($_block_repeat) { ob_start(); ?>posts<?php $_block_content = ob_get_contents(); ob_end_clean(); echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat=false); }  array_pop($this->_tag_stack); ?></td>
			</tr>
