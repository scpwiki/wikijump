...
export class SwipeObserver {
  ...
  declare private opts: SwipeOpts

  /** List of valid swipe directions. */
  declare private directions: Direction[]

  /** Internal {@link GestureObserver} used to get gesture information. */
  declare private observer: GestureObserver
  ...
  /**
   * Runs the configured condition, if present. Returns `true` if it isn't
   * present.
   */
