...
export abstract class BaseTooltipButton extends BaseButton {
  /**
   * The parent element. This is what the tooltip will be placed relative
   * to.
   */
  ...
  declare private onTimer?: Timeout

  /** Timer to keep track of the delay for hiding the tooltip. */
  declare private offTimer?: Timeout

  /** The Popper.js instance for handling placement of the tooltip. */
  declare private popperInstance?: Popper.Instance

  /** Internal observer for hover events. */
  declare private hoverObserver: HoverObserver
  ...
  /**
   * Internal event that is fired when the element is no longer being
   * hovered over.
   */
