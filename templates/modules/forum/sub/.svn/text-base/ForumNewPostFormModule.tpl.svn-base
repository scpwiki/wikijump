<div id="new-post-preview-div" style="display: none">
	...
	<div></div>
	<a href="javascript:;" onclick="WIKIDOT.modules.ForumNewPostFormModule.listeners.closePreview(event)">{t}close preview{/t}</a>
</div>
...
<div id="new-post-div">
	<form id="new-post-form">
		...
		<div class="buttons alignleft">
			<input type="button" value="{t}cancel{/t}" id="np-cancel" onclick="WIKIDOT.modules.ForumNewPostFormModule.listeners.cancel(event)"/>
