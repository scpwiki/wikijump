	...
	<ul>
		{if $tips.avatar}
			<li>
				...
				{t escape=no}Go to <em>my profile</em>{/t} >> <em><a href="javascript:;" onclick="OZONE.ajax.requestModule('account/profile/APAvatarModule', null, WIKIDOT.modules.AccountModule.callbacks.menuClick)">{t}my buddy icon{/t}</a></em> {t}to upload your very own image{/t}.
			</li>
		{/if}
	</ul>
...
<ul>
	...
	<li><a href="http://{$URL_HOST}">Go to main page</a></li>
