...
{if $type=="P" || $type=="M" || $type=="Z" || $type=="X"}
	...
	<div class="page-rate-widget-box">
		...
		<span class="one"><a title="{t}1{/t}" href="javascript:;" onclick="WIKIDOT.modules.PageRateWidgetModule.listeners.rate(event, 1)">1</a></span>
		<span class="two"><a title="{t}2{/t}" href="javascript:;" onclick="WIKIDOT.modules.PageRateWidgetModule.listeners.rate(event, 2)">2</a></span>
		<span class="three"><a title="{t}3{/t}" href="javascript:;" onclick="WIKIDOT.modules.PageRateWidgetModule.listeners.rate(event, 3)">3</a></span>
		<span class="four"><a title="{t}4{/t}" href="javascript:;" onclick="WIKIDOT.modules.PageRateWidgetModule.listeners.rate(event, 4)">4</a></span>
		<span class="five"><a title="{t}5{/t}" href="javascript:;" onclick="WIKIDOT.modules.PageRateWidgetModule.listeners.rate(event, 5)">5</a></span>
		<span class="cancel"><a title="{t}Cancel my vote{/t}" href="javascript:;" onclick="WIKIDOT.modules.PageRateWidgetModule.listeners.cancelVote(event)">x</a></span>
	</div>
{/if}
{/strip}
