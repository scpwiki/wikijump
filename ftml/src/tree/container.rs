...
impl ContainerType {
    ...
    pub fn html_tag(self) -> HtmlTag {
        match self {
            ...
            ContainerType::Hidden => HtmlTag::with_class("div", "hidden"),
            ContainerType::Invisible => HtmlTag::with_class("div", "invisible"),
    ...
    pub fn paragraph_safe(self) -> bool {
        match self {
            ...
            ContainerType::Deletion => false,
            ContainerType::Hidden => false,
