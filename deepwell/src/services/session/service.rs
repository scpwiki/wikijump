...
impl SessionService {
    ...
    pub async fn get(ctx: &ServiceContext, session_token: &str) -> Result<SessionModel> {
    ...
    pub async fn invalidate(ctx: &ServiceContext, session_token: String) -> Result<()> {
    ...
    pub async fn prune(ctx: &ServiceContext) -> Result<u64> {
