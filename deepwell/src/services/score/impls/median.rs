...
fn median() {
    ...
    check!(0, votes! { -1 => 4, 0 => 1, 1 => 4 });
    check!(1, votes! { -1 => 4, 0 => 1, 1 => 5 });

    check!(0, votes! { -1 => 2, 0 => 4, 1 => 5 });
    check!(1, votes! { -1 => 2, 0 => 4, 1 => 8 });
    check!(3, votes! { 1 => 6, 2 => 3, 3 => 5, 4 => 3, 5 => 6 });
    check!(4, votes! { 1 => 3, 2 => 2, 3 => 8, 4 => 12, 5 => 10 });
}
