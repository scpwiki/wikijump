...
export interface paths {
  ...
  "/account/register": {
    /** Registers an account. Does not automatically login. Email validation will be required. */
  ...
  "/user/{path_type}/{path}": {
    ...
    parameters: {
      ...
      query: {
        /** Endpoints that may return user details will have those details sent with 16x16 avatars. These are meant for display on a frontend. This parameter allows you to disable this behavior if you do not need the avatars. */
  ...
  "/page/{path_type}/{path}/revision": {
    ...
    parameters: {
      ...
      query: {
        ...
        /** Specifies how many entries a paginated response should return in a single page. */
  ...
  "/forum/thread/{id}/posts": {
    ...
    parameters: {
      ...
      query: {
        ...
        /** Specifies the maximum number of replies (sub-posts) included with any retrieved post. */
...
export interface components {
  ...
  parameters: {
    ...
    /** Specifies thread/post deletion should result in permanent deletion rather than archival. */
