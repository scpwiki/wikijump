...
<table class="pm-list">
	...
	{foreach from=$messages item=message}
		<tr>
			...
			<td class="subject">
				<a href="javascript:;"
				onclick="Wikijump.modules.AccountMessagesModule.listeners.viewDraftsMessage({$message->id})">{if $message->subject}{$message->subject|escape}{else}<em>no subject yet</em>{/if}</a>
			</td>
			<td>
