...
{*
	{if $revisions}
		{foreach from=$revisions item=revision}
			...
			<div class="list-item">
				<div class="title">
					<a href="http://{$site->getDomain()|escape}/{$page->slug}">{$page->getTitleOrUnixname()|escape}</a>
				</div>
				<div class="in-site">
...
*}
	{if $pages}
		{foreach from=$pages item=page}
			...
			<div class="list-item">
				<div class="title">
					<a href="{$HTTP_SCHEMA}://{$site->getDomain()|escape}/{$page->slug}">{$page->getTitleOrUnixname()|escape}</a>
				</div>
				<div class="in-site">
