...
class CategoryPeerBase extends BaseDBPeer
{
    ...
    protected function internalInit()
    {
        ...
        $this->defaultValues = array( 'theme_default' => 'true',  'permissions_default' => 'true',  'license_default' => 'true',  'nav_default' => 'true',  'per_page_discussion_default' => 'true',  'autonumerate' => 'false' );
    }
