...
class Lucene
{
    ...
    public function rawQuery($query)
    {
        ...
        $result = $this->executeWikijumpSearch($query);
    ...
    /**
     * high level Wikijump search function
    ...
    protected function executeWikijumpSearch($query)
    {
        $results = array();
        if (GlobalProperties::$SEARCH_USE_JAVA) {
            $cmd = "java -jar " . escapeshellcmd(WIKIJUMP_ROOT . "/bin/wikijump_search.jar");
