...
use Wikijump\Facade\Exception\WrongArguments;
use DB\Page;
use DB\Category;
use DB\Site;
use DB\File;
use Wikijump\Facade\Exception\WrongReturnValue;
    ...
    protected function parseArgs($args, $requiredArgs = array())
    {
        ...
        foreach ($args as $key => $value) {
            switch ($key) {
                case "performer":
                    if ($this->performer) {
                        //throw new Wikijump\Facade_Exception_WrongArguments("Array key performer is for internal use only");
                    } else {
