...
require_once(WIKIJUMP_ROOT . "/lib/sfyaml/lib/sfYamlParser.php");
require_once(WIKIJUMP_ROOT . "/lib/sfyaml/lib/sfYaml.php");
require_once(WIKIJUMP_ROOT . "/lib/spyc/spyc.php");
...
class Yaml
{
    public static function load($string, $forgiving = false)
    {
        ...
        try {
            ...
            throw new Exception("Can't parse the YAML string." . $e->getMessage());
        }
    }
