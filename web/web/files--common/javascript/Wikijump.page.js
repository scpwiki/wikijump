...
Wikijump.page.listeners = {
	editClick: function(e){
		...
		if(Wikijump.page.vars.forceLockFlag == true){
			Wikijump.page.vars.forceLockFlag = false;
	...
	logoutClick: function(e){
		...
		p.event = "logout";
		OZONE.ajax.requestModule(null,p,Wikijump.page.callbacks.logoutClick);
	},
	...
	loginClick2: function(e, resetRemember){
		...
		var url=window.location.protocol+'//www.wikijump.com/default--flow/login__LoginIframeScreen';
	...
	loginClick0: function(e, resetRemember){
		var p = new Object();
		if(resetRemember){ p.reset = "yes"; }
		OZONE.ajax.requestModule("login/LoginModule", p, Wikijump.page.callbacks.loginClick);
	},
	...
	toggleEditSections: function(e){
		if(Wikijump.page.vars.editSectionsActive == false){
			...
			var edits = Wikijump.page.vars.sectionEditButtons;
	...
	editTags: function(e){
		...
		OZONE.ajax.requestModule("pagetags/PageTagsModule", p, Wikijump.page.callbacks.editTags);

	},

	siteTools: function(e){
		OZONE.ajax.requestModule("sitetools/SiteToolsModule", null, Wikijump.page.callbacks.siteTools);
	...
	userInfo: function(userId){
		var p = new Object();
		p['user_id'] = userId;
		OZONE.ajax.requestModule("users/UserInfoWinModule", p, Wikijump.page.callbacks.userInfo);
	},
	anonymousUserInfo: function(userString){
		var p = new Object();
		p.userString = userString;
		OZONE.ajax.requestModule("users/AnonymousInfoWinModule", p, Wikijump.page.callbacks.userInfo);
	},

	renamePage: function(e){
		var p = new Object();
		p['pageId'] =  WIKIREQUEST.info.pageId;
		OZONE.ajax.requestModule("rename/RenamePageModule", p, Wikijump.page.callbacks.renamePage);
	...
	createPageDiscussion: function(e){
		...
		OZONE.ajax.requestModule("Empty", p, Wikijump.page.callbacks.createPageDiscussion);
	},

	flagPageObjectionable: function(e){
		var p = new Object();
		p.path = window.location.pathname;
		OZONE.ajax.requestModule('report/FlagPageModule', p, Wikijump.page.callbacks.flagPageObjectionable);
	},
	pageBugReport: function(e){

		OZONE.ajax.requestModule('report/BugReportModule', null, Wikijump.page.callbacks.pageBugReport);
	},
	pageRate: function(e){
		OZONE.ajax.requestModule('pagerate/PageRateModule', {pageId: WIKIREQUEST.info.pageId}, Wikijump.page.callbacks.pageRate);
	},
	parentClick: function(e){
		var p = new Object();
		p['page_id']=WIKIREQUEST.info.pageId;
		OZONE.ajax.requestModule("parent/ParentPageModule",p,Wikijump.page.callbacks.parentClick);

	},
	passwordRecoveryClick: function(e){
		OZONE.ajax.requestModule("passwordrecovery/PasswordRecoveryModule", null, Wikijump.page.callbacks.passwordRecovery);
	},
...
Wikijump.page.callbacks = {
	...
	editClick: function(response){
		...
		if(Wikijump.page.vars.newPage == true){
		...
		if(response.locked == true){
			...
			Wikijump.page.vars.editlock = new Object();
			Wikijump.page.vars.editlock.id = response['lock_id'];
			Wikijump.page.vars.editlock.secret = response['lock_secret'];
			Wikijump.page.vars.editlock.revisionId = response['page_revision_id'];
			Wikijump.page.vars.editlock.timeLeft = response.timeLeft;
	...
	passwordRecovery: function(r){
		if(!Wikijump.utils.handleError(r)) {return;}
		Wikijump.vars.rsakey = r.key;
		Wikijump.vars.loginSeed = r.seed;
...
Wikijump.page.utils = {
	...
	openHelpPop: function(topicName){
		...
		var newwindow = window.open("https://test.wikijump.com/default--screen/HelpPop/topic/"+topicName, "_blank",'location=no,menubar=no,titlebar=no,resizable=yes,scrollbars=yes,width=' + (screen.width*0.8) + ',height=' +
			(screen.height*0.8) + ',top='+ (screen.height*0.1) +',left='+(screen.width*0.1));
		return newwindow;
...
Wikijump.page.account = {};
Wikijump.page.account.shower = function(e){
...
Wikijump.page.account.closer = function(e){
	var ao = $("account-options");
...
Wikijump.page.init = function(){
	...
	OZONE.dom.onDomReady(function(){
		...
		Wikijump.render.fixAvatarHover();
	...
	var ctrle = new YAHOO.util.KeyListener(document, {keys:69, ctrl:true}, function(type,e){
			e = e[1];
			Wikijump.page.listeners.editClick(e);
