...
// invocation
				...
				System.err.println("  java -jar wikijumpIndexer.jar process <index_dir> <queue_file> <lock_file>");
				System.err.println("  java -jar wikijumpIndexer.jar search <index_dir> <search_phrase>");
