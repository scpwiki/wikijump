...
Of course, you should adjust the path on the right-hand side appropriately to whatever directory is unable to be written to. Typically it is a data directory such as `storage` or `logs`.
