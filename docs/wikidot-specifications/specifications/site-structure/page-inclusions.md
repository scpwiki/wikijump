# Page inclusion relationships

- Feature ID: `page-inclusions`
...
Implement the documented Wikidot site-structure capability “Page inclusion relationships”, including its identity, relationships, routes, and rendering implications.
...
- `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/doc:site-structure/source.wikidot.txt:31` through line 34 (canonical)

## Documentation-derived behavioral evidence

### doc:site-structure (canonical)

Source: `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/doc:site-structure/source.wikidot.txt:31` through line 34  
