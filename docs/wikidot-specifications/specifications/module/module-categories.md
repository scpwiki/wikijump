...
Implement the `Categories` module interface, attributes, defaults, selection or side-effect behavior, templates, output, and documented limitations.
...
- `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/doc-modules:categories-module/source.wikidot.txt:1` through line 19 (canonical)

## Documentation-derived behavioral evidence

### doc-modules:categories-module (canonical)

Source: `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/doc-modules:categories-module/source.wikidot.txt:1` through line 19  
SHA-256 of complete source file: `f40fab9fd57f2b7ffd941984a90c4a4328c4b38be539b34b12b08dbb1b8c28df`

```wikidot
L0001 The Categories module is a tool that displays categories and their pages within a site.  This tool will eventually be replaced by [/doc:listpages-module ListPages], which is more general purpose.
L0002 
L0003 ++ Attributes
L0004 
L0005 ||~ attribute ||~ required ||~ allowed values ||~ default ||~ description ||
L0006 || includeHidden || no || {{true}} || {{false}} || includes "hidden" (starting with underscore) pages in the listing ||
L0007 
L0008 
L0009 ++ Example
L0010 
L0011 To use Categories, add this code to your page:
L0012 
L0013 [[code]]
L0014 [[module Categories]]
L0015 [[/code]]
L0016 
L0017 In action:
L0018 
L0019 [[module Categories]]
```
