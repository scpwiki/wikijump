# Site and page metadata tags

- Feature ID: `meta-tags`
- Category: `platform`
...
Implement the documented Wikidot capability “Site and page metadata tags” and its user-visible configuration, state, permissions, and output.
...
- `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/features/source.wikidot.txt:151` through line 155 (supporting)

## Documentation-derived behavioral evidence

### features (supporting)

Source: `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/features/source.wikidot.txt:151` through line 155  
SHA-256 of complete source file: `2f543ffe5d97f77da4936b7ab95ac66493b1acedd2bea01d5b956735b1b9501c`

```wikidot
L0151 +++ EDITING OF <META> TAGS
L0152 You can set up <META> tags for the whole site or separately for every page. It can be useful e.g. to change the description of your site, keywords found by search engines etc.
L0153 
L0154 
L0155 
```
