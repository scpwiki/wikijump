...
Implement the documented Wikidot capability “Site membership” and its user-visible configuration, state, permissions, and output.
...
- `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/features/source.wikidot.txt:111` through line 115 (supporting)

## Documentation-derived behavioral evidence

### features (supporting)

Source: `~/src/Rokurolize/scp-wiki-translation/corpus/www/pages/features/source.wikidot.txt:111` through line 115  
SHA-256 of complete source file: `2f543ffe5d97f77da4936b7ab95ac66493b1acedd2bea01d5b956735b1b9501c`

```wikidot
L0111 +++ MEMBERSHIP ON YOUR SITE
L0112 You can also allow Users to join your Sites and assign them roles (pages/forum Moderators, Administrators or just Members).
L0113 
L0114 
L0115 
```
