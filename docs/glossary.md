...
| Mirror site      |            |             | A site whose pages are expected to reflect an upstream published corpus and should not include local draft translations by default. |
| Editable corpus site |            |             | A local site intended for translation drafts and direct human/AI edits before publication into a mirror. |
